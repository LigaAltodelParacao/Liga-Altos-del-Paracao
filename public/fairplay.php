        ...
        SELECT 
            ...
            ROUND((COALESCE(SUM(CASE WHEN ep.tipo_evento = 'amarilla' THEN 1 ELSE 0 END), 0) * 1 +
             ...
             COALESCE(SUM(CASE 
                ...
                ELSE 0 
             END), 0) * 5) / 
             NULLIF(COUNT(DISTINCT CASE WHEN p.estado = 'finalizado' THEN p.id END), 0), 2) AS promedio
        FROM equipos e
...
if ($categoria_id && !empty($fairplay)) {
    ...
    $stats = [
        ...
        'promedio_puntos' => $total_equipos > 0 ? round($total_puntos / $total_equipos, 2) : 0
    ];
}
?>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="stats-card">
                                ...
                                <div class="number text-info"><?= $stats['promedio_puntos'] ?></div>
                                <div class="label">Promedio por Equipo</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover tabla-fairplay mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 10%;">Prom</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            foreach ($fairplay as $i => $f): 
                                ...
                                elseif ($f['puntos'] > $stats['promedio_puntos']) $badge_class = 'badge-warning';
                                if ($es_peor) $badge_class = 'badge-danger';
                            ...
                            <tr class="fairplay-row <?= $row_class ?>" style="background-color: <?= $i % 2 == 0 ? '#f9f9f9' : '#ffffff' ?>;">
                                ...
                                <td class="text-center">
                                    <span class="text-muted"><?= $f['promedio'] ?? '0.00' ?></span>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <small>
                                ...
                                <strong>Prom:</strong> Promedio de puntos por partido<br>
                            </small>
                        </div>
                        <div class="col-md-6">
                            <small>
